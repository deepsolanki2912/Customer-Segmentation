...
def main():
    ...
    last_purchase_date = st.sidebar.date_input('Last Purchase Date', value=pd.Timestamp('2011-12-01'), min_value=pd.Timestamp('2010-12-01'), max_value=pd.Timestamp('2011-12-09'))
    ...
    num_days = (pd.Timestamp('2021-12-09') - last_purchase_date).days
